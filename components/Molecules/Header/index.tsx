...
export default function Header({ onPressPlus }: HeaderProps) {
  ...
  return (
    ...
    >
      <View className="relative flex flex-row items-center justify-center w-full gap-2">
        ...
        <TouchableOpacity
          onPress={onPressPlus} // 👈 chama o modal ao clicar
          activeOpacity={0.8}
          className="w-12 h-12 rounded-full bg-[#ffe6d4] border border-white overflow-hidden absolute right-0"
        >
          <AntDesign
            name="plus"
            size={24}
